...
import PrayerTimesGrid from "@frontend/components/prayer/PrayerTimesGrid";
import { getNextPrayer } from "@frontend/components/prayer/prayerUtils";
import {
  CALENDAR_MONTHS,
  formatShortDate,
  getDailySchedule,
  ...
  PRAYER_NAMES,
} from "@frontend/lib/prayerSchedule";
