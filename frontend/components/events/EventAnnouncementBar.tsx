...
import { featuredEvent, usePublicEvents } from "@frontend/components/events/usePublicEvents";
import { eventAnnouncementContent } from "@frontend/content/EventsContent";
