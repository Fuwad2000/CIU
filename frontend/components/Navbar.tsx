...
import AnnouncementTicker from "@frontend/components/AnnouncementTicker";
import {
  donateLink,
  navBarContent,
  navLinks,
} from "@frontend/content/NavBarContent";
import type { NavItem } from "@frontend/content/types";
