...
export const adminThemeBootScript = `(function(){try{document.documentElement.classList.add("admin-type");var t=localStorage.getItem("${ADMIN_THEME_KEY}");var dark=t==="dark"||(t!=="light"&&window.matchMedia("(prefers-color-scheme: dark)").matches);if(dark)document.documentElement.classList.add("admin-dark");}catch(e){}})();`;
