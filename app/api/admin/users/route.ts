import { actorCapabilities, requireAdminActor } from "@/lib/portal/admin-auth";
import { canViewAdmins, isCreatableAdminRole, requestedCreateRole } from "@/lib/portal/admin-roles";
import { denyCreateAdmin } from "@/lib/portal/admin-policy";
import { jsonError, jsonOk, readString, recordHistory, requireAdmin } from "@/lib/portal/http";
import { createStaffUser, listStaffUsers } from "@/lib/portal/sql-store";
