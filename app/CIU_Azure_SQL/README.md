...
The website reads these tables through server-side Next.js API routes. `lib/portal/db.ts` connects with a Microsoft Entra access token from `DefaultAzureCredential`. There is no SQL username or password.
